...
export async function getQueues(
  ...
  return client.request(withQuery("/queues", query), paginatedQueuesSchema, { signal });
}
...
export async function purgeQueue(client: ManagementApiClient, vhost: string, name: string) {
