...
import type { ChannelViewModel } from "./channel-view-model";
...
/** Reusable entity columns for channel lists embedded in multiple screens. */
export function createChannelColumns(t: (key: string) => string): ColumnDef<ChannelViewModel>[] {
  return [
    {
      accessorKey: "name",
