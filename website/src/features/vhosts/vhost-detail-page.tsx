...
import { ArrowLeft, Cable, ListTree, Pencil, Power, Trash2, Waypoints } from "lucide-react";
...
export function VhostDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <nav aria-label={t("common.resources")} className="flex flex-wrap items-center gap-3">
