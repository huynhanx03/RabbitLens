...
export function SuperStreamPage() {
  ...
  const submit = (values: FormValues) => {
    try {
      ...
      create.mutate({ vhost: values.vhost, name: values.name, body }, { onSuccess: () => reset() });
    } catch {
      setJsonError(true);
    }
  };
      ...
      <div className="max-w-2xl rounded-xl border bg-card p-5">
        ...
        <form className="space-y-4" onSubmit={handleSubmit(submit)} noValidate>
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="super-vhost" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              disabled={create.isPending}
            >
              <SelectTrigger id="super-mode" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          {mode === "partitions" ? (
            ...
            <div className="space-y-2">
              ...
              <Input
                id="super-binding-keys"
                {...register("bindingKeys")}
                disabled={create.isPending}
              />
            </div>
          )}
