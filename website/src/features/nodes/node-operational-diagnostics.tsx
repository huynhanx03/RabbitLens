...
function MetricSection({ title, items }: { title: string; items: MetricItem[] }) {
  ...
  return (
    <SectionCard title={title}>
      <DefinitionList items={available} unavailableLabel="—" />
    </SectionCard>
  );
}
    ...
    <div className="grid gap-4 xl:grid-cols-3">
      <MetricSection
        ...
        items={[
          ...
          {
            label: t("nodes.queueIndexJournalWrites"),
            value: node.queue_index_journal_write_count,
          },
